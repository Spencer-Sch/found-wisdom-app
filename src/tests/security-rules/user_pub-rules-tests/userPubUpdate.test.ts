...
describe('Tests for usersCollection/user_pub "allow update" security rules', () => {
  test("unathorized user can't update usersCollection/{userId}/user_pub/user_pub doc", async () => {
    // setup
  ...
  test("authorized user can't update a usersCollection/{userId}/user_pub/user_pub doc under a different userId", async () => {
    // setup
  ...
  test('authorized user can update their own usersCollection/{userId}/user_pub/user_pub doc as long as the doc meets all criteria', async () => {
    // setup
    const setupDoc = getSetupDoc(myUid);
    await setupDoc.set(user_pub_correct_doc);
    // test
  ...
  test("authorized user can't update their own usersCollection/{userId}/user_pub/user_pub doc with unrecognized field(s)", async () => {
    // setup
    const setupDoc = getSetupDoc(myUid);
    await setupDoc.set(user_pub_correct_doc);
    // test
  ...
  test("authorized user can't update their own usersCollection/{userId}/user_pub/user_pub doc 'username' field if it is not a string", async () => {
    // setup
    const setupDoc = getSetupDoc(myUid);
    await setupDoc.set(user_pub_correct_doc);
    // test
  ...
  test("authorized user can't update their own usersCollection/{userId}/user_pub/user_pub doc 'profile_img' field if it is not a string", async () => {
    // setup
    const setupDoc = getSetupDoc(myUid);
    await setupDoc.set(user_pub_correct_doc);
    // test
