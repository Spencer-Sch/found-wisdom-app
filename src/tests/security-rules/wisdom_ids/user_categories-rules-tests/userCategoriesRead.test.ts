...
describe('Tests for usersCollection/{userId}/wisdom_ids/user_categories "allow read" security rules', () => {
  test("unauthorized user can't read from usersCollection/{userId}/wisdom_ids/user_categories", async () => {
    // setup
  ...
  test('authorized user can read their own usersCollection/{userId}/wisdom_ids/user_categories doc', async () => {
    // setup
    const setupDoc = getSetupDoc(myUid);
    await setupDoc.set(user_categories_correct_doc);
    // test
  ...
  test("authorized user can't read another user's usersCollection/{userId}/wisdom_ids/user_categories doc", async () => {
    // setup
